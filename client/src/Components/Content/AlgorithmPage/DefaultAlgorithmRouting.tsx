...
interface IDefaultAlgorithmRoutingProps extends React.PropsWithChildren {
    routeToRedirectTo: string,
    match: {params: {algorithmType: string, algorithmTitle: string}}
}

export default function DefaultAlgorithmRouting({routeToRedirectTo, match: {params}}: IDefaultAlgorithmRoutingProps) {
